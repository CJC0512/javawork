...
public class Application1 {
    public static void main(String[] args) {
        ...
        long count = IntStream.range(1, 10).count();        // .count()가 long형으로 받아쓰기에, long으로 선언함.
...
//        OptionalInt max = IntStream.range(1, 1).max();        // max = OptionalInt.empty 형태로 나오고 기본자료형에서 존재하지 않음을 나타내기 위함을 알 수 있다.
