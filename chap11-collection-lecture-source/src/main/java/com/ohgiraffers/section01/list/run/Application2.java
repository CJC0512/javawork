...
//        Collections.sort(bookList, new AscendingPrice());           // AscendingPrice(Comparator)의 compare 메소드가
                                                                      // bookList(Comparable)의 compareTO 메소드 보다더 강하다.
                                                                      // (compare 메소드를 최종적으로 적용함)
