...
//        StringBuilder sb2 = "java";            // StirngBuilder는 문자열을 다루지만 리터럴은 다루지 않음.??
        ...
        for (int i = 0; i < 9; i++) {
            ...
            /* 필기.
             *   String은 hashCode()메소드가 동등 비교를 위해 오버라이딩 되어 있어 주소값을 확인하기 힘들다.
             *   따라서 System.identityHashCode() 메소드를 활용해 String으로 관리되는 문자열과
             *   StringBuilder로 관리되는 문자열이 각각 변화를 줄 때 새로운 객체를 생성하는지 살펴보자
             * */
