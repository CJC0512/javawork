...
//        Calendar cal = new Calendar();
        ...
        Calendar cal2 = new GregorianCalendar();        // 일반적으로 GregorianCalendar를 사용
        System.out.println("cal2 = " + cal2);

        int year = 1999;
        int month = 4;      // 1~12월을 0~11로 한도하였기에, 입력하고자 하는 월 -1
        int dayOfMonth = 12;
        int hour = 2;
        int min = 0;
        int second = 0;
        ...
        System.out.println("태어난 월: " + (birthDay.get(2)+ 1));         // get() Method로 반환받은 값에 +1 해줘야 우리가 생각하는 월의 개념이 된다.
        ...
        /* 설명. SimpleDateFormat 활용하기(feat. java.util.Date 형으로 변환 후 활용) */
