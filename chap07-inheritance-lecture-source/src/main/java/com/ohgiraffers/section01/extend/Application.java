...
public class Application {
    ...
    public static void main(String[] args) {
         ...
         *   현재 가장 중요한 의미는 '다형성을 물려받기 위한 문법적 토대'가 된다든 사실이다.
         *
         *  필기.
         *   상속의 이점
         ...
         *  필기.
         *   상속의 단점
         *    1. 부모 클래스의 기능을 추가/변경할 시 자식 클래스가 정상적을 작동하게 될지 예측이 힘들다.
         ...
         *  필기.
         *   메소드 오버라이딩이란?
         *    메소드 재정의(Overriding)하는 것으로 부모 메소드의 헤드부를 그대로 사용하면서 자식 클래스가
         *    이후 다형성을 적용하면 자식의 오바라이딩 된 메소드가 우선적으로 동작하게 딘다.(동적 바인딩)
         *
         *  필기.
         *   장점과 단점을 고려했을 때, 상속은 오용의 가능성이 있기 때문에 IS-A 관계로 구분되는 경우에
         *   잘 고려하여 적용해야 한다.
         *   (IS-A 관계 vs HAS-A 관계)
         * */
        Car car = new Car();
