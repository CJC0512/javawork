...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(product1);       // toString 메소드를 Overriding 을 했으니, toString 내용이 나온다.
        ...
        Computer computer3 = new Computer("S-01234", "Google", "Pixel", 1000000,
                new java.util.Date(), "퀄컴 스냅드래곤", 512, 16, "안드로이드");
