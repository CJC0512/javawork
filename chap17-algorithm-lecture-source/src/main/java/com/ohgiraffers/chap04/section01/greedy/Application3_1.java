...
public class Application3_1 {
    ...
    public static int solution(String input) throws IOException {
        ...
        int N = Integer.valueOf(br.readLine());     // 모든 회의 수
        int[][] time = new int[N][2];              // 모든 회의에 대한 각각의 시작/종료시간을 가지고 있는 배열
        StringTokenizer str;
        for (int i = 0; i < N; i++) {
         ...
         * */
        Arrays.sort(time, (o1, o2) -> {         // 기본적으로 오름차순
            /* 필기. o1: 회의1  o2: 회의2
            *       o1[0]: 회의1의 시작시간  o2[0]: 회의2의 시작시간
            *       o1[1]: 회의1의 종료시간  o2[1]: 회의2의 종료시간
            * */
