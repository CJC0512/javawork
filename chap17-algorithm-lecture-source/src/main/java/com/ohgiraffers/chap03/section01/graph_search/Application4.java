...
public class Application4 {
    ...
    public static String solution(String input) throws IOException {
        ...
        /* 설명. dfs 할 때, visit 배열을 활용하기 때문에 아래 bfs를위해 다시 false로 채워진 boolean[]로 초기화 */
        visit = new boolean[node +1];   // visit 객체를 앞서 사용하였기에, 이를 초기화
        bfs(start);
    ...
    private static void dfs(int start) {
        ...
        /* 설명. node 번호와 인덱스가 동일한 체계이기에 i는 node 번호까지 포함되어 반복되어야 한다. */
