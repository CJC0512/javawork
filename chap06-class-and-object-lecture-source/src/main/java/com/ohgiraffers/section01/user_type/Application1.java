...
public class Application1 {
    ...
    public static void main(String[] args) {
         ...
         *   3. 메소드의 반환형응로 회원이라는 개념을 반환할 수 없다.(메소드의 반환형은 하나여야 하기 때문에)
         * */
        ...
        Member renmaeMember = printMember(member1);
        System.out.println(renmaeMember.age);
        System.out.println(Arrays.toString(renmaeMember.hobby));
    }

    private static Member printMember(Member member1) {
