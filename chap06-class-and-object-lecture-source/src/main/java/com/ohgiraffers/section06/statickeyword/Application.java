...
public class Application {
    public static void main(String[] args) {
        ...
        * */
        ...
        System.out.println("stf1 non-static field: " + stf1.getNonStaticCount());
        System.out.println("static field: " + StaticFieldTest.getStaticCount());

        /* 설명. 각 필드 값들을 하나씩 증가 */
        stf1.increaseNonStaticCount();
        StaticFieldTest.increseStaticCount();
        ...
        System.out.println("stf2 non-static field: " + stf2.getNonStaticCount());
        System.out.println("static field: " + StaticFieldTest.getStaticCount());
