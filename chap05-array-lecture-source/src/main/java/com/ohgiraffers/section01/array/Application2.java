...
//        iArr = new int[];     // 배열은 반드시 크기를 할당해 주어야 한다.
        ...
        System.out.println("iARR = " + cArr.hashCode());

        /* 필기. null값을 지닌 참조 자료형 변수 (아무것도 참조하지 않는 때)를 접근 시 발생하는 에러 확인 */
//        cArr = null;
//        System.out.println("null을 참조할 시: " + cArr.hashCode());      // 오류 발생 NullPointerException
